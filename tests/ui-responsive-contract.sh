...
check_block_absent 'sidebar no longer relies on backdrop blur 16px' '.sidebar' 'backdrop-filter' 'blur(16px)'
check_block_property 'dark theme sidebar uses translucent grain overlay' '[data-theme="dark"]' '--sidebar-bg' 'rgba(0, 0, 0'
check_block_property 'light theme sidebar uses translucent grain overlay' '[data-theme="light"]' '--sidebar-bg' 'rgba(255, 255, 255'
