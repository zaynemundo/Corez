...
check_block_property 'dark theme sets solid elevated sidebar background' '[data-theme="dark"]' '--sidebar-bg' '#0a0a0a'
check_block_property 'light theme overrides sidebar glass background' '[data-theme="light"]' '--sidebar-bg' '#fafafa'
