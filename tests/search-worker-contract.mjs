...
async function run() {
  ...
  // serves muse-spark-1.2-contributor.
  ...
  // gateway (perplexity model), still with only the muse-spark-1.2-contributor key.
  ...
  // When both providers are configured, OpenCode Go (muse-spark-1.2-contributor
