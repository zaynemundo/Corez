...
opencodeClient="worker/opencodeClient.js"
imageProvider="worker/imageProvider.js"
...
check 'Worker routes text through OpenCode Go with the DeepSeek V4.1 Flash build' 'deepseek-v4.1-flash' "$providerChain"
...
check 'Worker routes image generation through OpenRouter' 'openrouter[.]ai' "$imageProvider"
...
check 'Worker uses the OpenCode Go endpoint' 'opencode[.]ai' "$opencodeClient"
