...
check 'Worker prefers OpenCode Go with a multi-model fallback list' 'OPENCODE_GO_MODELS' "$worker"
check 'OpenCode Go fallback list includes deepseek-v4-pro' 'deepseek-v4-pro' "$worker"
check 'OpenCode Go fallback list includes kimi-k3' 'kimi-k3' "$worker"
