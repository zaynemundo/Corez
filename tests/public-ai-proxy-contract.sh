...
check 'README documents the primary FLUX image model' '@cf/black-forest-labs/flux-1-schnell' "$readme"
check 'README documents the fallback FLUX image model' '@cf/black-forest-labs/flux-1-dev' "$readme"
