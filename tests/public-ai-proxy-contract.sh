...
check 'README documents primary text routing' 'tencent/hy3-preview|kimi-k3-code' "$readme"
check_absent 'README no longer documents MiMo V2.5' 'xiaomi/mimo-v2[.]5' "$readme"
check 'README documents the primary Workers AI fallback' '@cf/moonshotai/kimi-k3-code' "$readme"
