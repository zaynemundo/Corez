...
| PDF / Document Deliverables | `opencode-go/deepseek-flash` (preferred) | `pdf` | HTML/Paged.js or LaTeX PDF, processed PDFs |
| Live Facts / Lookups (weather, time, rates) | `opencode-go/deepseek-flash` | `live-utilities`, `research-current-information` | Dated, source-cited answer |
| Memory / Preferences | `opencode-go/deepseek-flash` | `r2-mem0-memory`, `personalisation-context` | R2-stored memory records |
