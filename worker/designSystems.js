...
export const DESIGN_ARCHETYPES = Object.freeze({
  'linear-dark': {
    ...
    description: 'Precision engineering aesthetic with dark surfaces, monochromatic borders, Geist typography, and glowing accents.',
  ...
  'apple-glass': {
    ...
    googleFontsImport: '@import url("https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap");',
    fontFamilies: {
  ...
  'cyberpunk-arcade': {
    ...
    googleFontsImport: '@import url("https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;600;700&family=JetBrains+Mono:wght@400;700&display=swap");',
    fontFamilies: {
