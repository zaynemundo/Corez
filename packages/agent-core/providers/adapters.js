...
export class OpenCodeGoAdapter extends ProviderAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      model: options.model ?? process.env.OPENCODE_MODEL ?? 'muse-spark-1.2',
...
export class DeepSeekAdapter extends ProviderAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      model: options.model ?? process.env.DEEPSEEK_MODEL ?? 'muse-spark-1.2'
    });
  }
...
export class OpenRouterAdapter extends ProviderAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      model: options.model ?? process.env.OPENROUTER_MODEL ?? 'muse-spark-1.2',
      referer: 'https://corez.ai',
      title: 'COREZ AI'
    });
  }
