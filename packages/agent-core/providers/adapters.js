...
export class OpenCodeGoAdapter extends ProviderAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      model: options.model ?? process.env.OPENCODE_MODEL ?? 'mimo-v2.5',
...
export class DeepSeekAdapter extends ProviderAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      model: options.model ?? process.env.DEEPSEEK_MODEL ?? 'mimo-v2.5'
    });
  }
...
export class OpenRouterAdapter extends ProviderAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      model: options.model ?? process.env.OPENROUTER_MODEL ?? 'mimo-v2.5',
      referer: 'https://corez.ai',
      title: 'COREZ AI'
    });
  }
