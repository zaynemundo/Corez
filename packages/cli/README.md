...
- **Model Router & Catalog**: Supports OpenCode Go (`deepseek-v4.1-flash`, `kimi-k3`), OpenRouter, and local fallback execution.
...
- `OPENCODE_GO_API_KEY` or `OPENCODE_API_KEY`: Key for OpenCode Go models (`deepseek-v4.1-flash`, `kimi-k3`).
