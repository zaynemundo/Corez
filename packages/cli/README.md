...
- **Model Router & Catalog**: Supports OpenCode Go (`deepseek-flash`, `kimi-k3`), OpenRouter, and local fallback execution.
...
- `OPENCODE_GO_API_KEY` or `OPENCODE_API_KEY`: Key for OpenCode Go models (`deepseek-flash`, `kimi-k3`).
